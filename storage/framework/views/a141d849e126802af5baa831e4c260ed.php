  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-emblem {
      ...
      color: var(--forest);
      font-weight: 700;
      box-shadow: 0 4px 15px rgba(201,148,62,0.3);
      flex-shrink: 0;
    }
    ...
    /* Arabic geometric pattern divider */
    .geo-pattern {
      position: absolute;
    ...
    .float-badge-3 {
      ...
      color: var(--cream-muted);
      animation: badge-float 6s ease-in-out infinite 2s;
    }
    ...
    .float-badge-3:hover, .float-badge-3 { animation: badge-float-mid 6s ease-in-out infinite 2s; }
    ...
    .gold-rule::before, .gold-rule::after {
      ...
      flex: 1;
      height: 1px;
      background: linear-gradient(to right, transparent, rgba(201,148,62,0.4), transparent);
    }
...
<nav class="navbar" id="mainNav">
  <div class="nav-inner">
    <a class="nav-brand" href="#">
      <div class="brand-emblem"><img src="<?php echo e(asset('gambar/ipnu.png')); ?>" alt=""></div>
      <div class="brand-text-wrap">
        <div class="brand-title">IPNU · IPPNU</div>
        <div class="brand-sub">Pelajar Nahdlatul Ulama</div>
      </div>
    </a>
    ...
    <div class="nav-burger" onclick="this.parentElement.querySelector('#navLinks').classList.toggle('open')">
      ...
      <table id="anggotaTable">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <div class="avatar-cell">
                <div class="avatar-circle" style="background:linear-gradient(135deg,#2d7a4f,#3da369);">MR</div>
          ...
          <tr>
            ...
            <td>
              <div class="avatar-cell">
                <div class="avatar-circle" style="background:linear-gradient(135deg,#c9943e,#e4b563);">SA</div>
          ...
          <tr>
            ...
            <td>
              <div class="avatar-cell">
                <div class="avatar-circle" style="background:linear-gradient(135deg,#7c3aed,#a855f7);">FA</div>
                <span>Fajar Abdurrahman</span>
              </div>
            </td>
            <td><span class="badge-ipnu">IPNU</span></td>
          ...
          <tr>
            ...
            <td>
              <div class="avatar-cell">
                <div class="avatar-circle" style="background:linear-gradient(135deg,#0891b2,#06b6d4);">NH</div>
                <span>Nur Halimah</span>
              </div>
            </td>
            <td><span class="badge-ipnu badge-ippnu">IPPNU</span></td>
            <td>Komisariat Al-Huda</td>
          ...
          <tr>
            ...
            <td>
              <div class="avatar-cell">
                <div class="avatar-circle" style="background:linear-gradient(135deg,#059669,#10b981);">AM</div>
                <span>Ahmad Maulana</span>
              </div>
            </td>
            <td><span class="badge-ipnu">IPNU</span></td>
            <td>Komisariat Nurul Huda</td>
  ...
  <div class="section-wrap">
    ...
    <div class="kegiatan-grid">
      <div class="kegiatan-card reveal rd1">
        <div class="kegiatan-thumb" style="background:linear-gradient(135deg,rgba(45,122,79,0.4),rgba(13,36,24,0.8));">
          🕌
        </div>
      ...
      <div class="kegiatan-card reveal rd2">
        <div class="kegiatan-thumb" style="background:linear-gradient(135deg,rgba(201,148,62,0.3),rgba(13,36,24,0.8));">
          📚
        </div>
        <div class="kegiatan-body">
      ...
      <div class="kegiatan-card reveal rd3">
        <div class="kegiatan-thumb" style="background:linear-gradient(135deg,rgba(99,102,241,0.3),rgba(13,36,24,0.8));">
          🏆
        </div>
        <div class="kegiatan-body">
      ...
      <div class="kegiatan-card reveal rd4">
        <div class="kegiatan-thumb" style="background:linear-gradient(135deg,rgba(16,185,129,0.3),rgba(13,36,24,0.8));">
          🤝
        </div>
        <div class="kegiatan-body">
...
<section id="quotes" style="padding:6rem 0;background:var(--forest);position:relative;overflow:hidden;">
  <div style="content:'';position:absolute;font-family:'Playfair Display',serif;font-size:28rem;color:rgba(201,148,62,0.03);top:-4rem;left:-1rem;line-height:1;pointer-events:none;z-index:0;font-weight:900;">"</div>
  ...
  <div class="section-wrap" style="text-align:center;position:relative;z-index:1;">
    <div class="reveal">
      ...
      <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;">
        ...
        <a href="#program" class="btn-outline">
          <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M14.5 10c-.83 0-1.5-.67-1.5-1.5v-5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5z"/><path d="M20.5 10H19V8.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/><path d="M9.5 14c.83 0 1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5S8 21.33 8 20.5v-5c0-.83.67-1.5 1.5-1.5z"/><path d="M3.5 14H5v1.5c0 .83-.67 1.5-1.5 1.5S2 16.33 2 15.5 2.67 14 3.5 14z"/><path d="M14 14.5c0-.83.67-1.5 1.5-1.5h5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5h-5c-.83 0-1.5-.67-1.5-1.5z"/><path d="M15.5 19H14v1.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5-.67-1.5-1.5-1.5z"/><path d="M10 9.5C10 8.67 9.33 8 8.5 8h-5C2.67 8 2 8.67 2 9.5S2.67 11 3.5 11h5c.83 0 1.5-.67 1.5-1.5z"/><path d="M8.5 5H10V3.5C10 2.67 9.33 2 8.5 2S7 2.67 7 3.5 7.67 5 8.5 5z"/></svg>
          Lihat Program
        </a>
      </div>
    </div>
...
<footer>
  <div class="footer-inner">
    <div class="footer-grid">
      <div>
        ...
        <div class="footer-socials">
          ...
          <a href="#" class="social-icon">
            <svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V9.07a8.27 8.27 0 004.84 1.55V7.19a4.85 4.85 0 01-1.07-.5z"/></svg>
          </a>
          <a href="#" class="social-icon">
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-org" style="font-family:'Amiri',serif;font-style:italic;color:rgba(201,148,62,0.6);">
...
</html><?php /**PATH C:\projekukk_MRafiAssidiqi_XIIRPL2\projekukk_MRafiAssidiqi_XIIRPL11\resources\views/user/index.blade.php ENDPATH**/ ?>