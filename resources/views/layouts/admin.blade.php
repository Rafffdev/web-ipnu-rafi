...
<div id="wrapper" class="d-flex">
  ...
  <nav id="sidebar" aria-label="Sidebar Navigation">
    ...
    <ul class="list-unstyled">
      ...
      <li>
        <a href="{{ route('admin.dataAlumni') }}" class="sidebar-link {{ request()->routeIs('admin.dataAlumni') ? 'active' : '' }}">
          <i class="fa-solid fa-user-graduate"></i> Data Alumni
        </a>
      </li>
      <li>
        <a href="{{ route('admin.prestasi') }}" class="sidebar-link {{ request()->routeIs('admin.prestasi') ? 'active' : '' }}">
          <i class="fa-solid fa-bullhorn"></i> Prestasi
        </a>
      </li>
      <li>
        <a href="{{ route('admin.pekerjaan') }}" class="sidebar-link {{ request()->routeIs('admin.pekerjaan') ? 'active' : '' }}">
          <i class="fa-solid fa-bullhorn"></i> Pekerjaan
        </a>
      </li>
      <li>
        <a href="{{ route('admin.pendidikan') }}" class="sidebar-link {{ request()->routeIs('admin.pendidikan') ? 'active' : '' }}">
